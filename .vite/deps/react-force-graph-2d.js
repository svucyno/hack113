...
function bindIndex(parent2, group, enter, update5, exit, data) {
...
function bindKey(parent2, group, enter, update5, exit, data, key) {
...
function data_default(value, key) {
  ...
  for (var m3 = groups.length, update5 = new Array(m3), enter = new Array(m3), exit = new Array(m3), j2 = 0; j2 < m3; ++j2) {
    var parent2 = parents[j2], group = groups[j2], groupLength = group.length, data = arraylike(value.call(parent2, parent2 && parent2.__data__, j2, parents)), dataLength = data.length, enterGroup = enter[j2] = new Array(dataLength), updateGroup = update5[j2] = new Array(dataLength), exitGroup = exit[j2] = new Array(groupLength);
...
function drag_default() {
  ...
  function mousedowned(event, d2) {
    if (touchending || !filter3.call(this, event, d2)) return;
  ...
  function touchstarted(event, d2) {
    if (!filter3.call(this, event, d2)) return;
...
function timer(callback, delay2, time) {
  var t3 = new Timer();
  t3.restart(callback, delay2, time);
  return t3;
}
function timerFlush() {
  now();
  ...
  var t3 = taskHead, e2;
  while (t3) {
    if ((e2 = clockNow - t3._time) >= 0) t3._call.call(void 0, e2);
    t3 = t3._next;
  }
  --frame;
}
...
function styleTween(name, value, priority) {
  ...
  function tween() {
    var i2 = value.apply(this, arguments);
    if (i2 !== i0) t3 = (i0 = i2) && styleInterpolate(name, i2, priority);
    return t3;
  }
  tween._value = value;
  return tween;
...
var polyOut = function custom2(e2) {
  e2 = +e2;
  function polyOut2(t3) {
    return 1 - Math.pow(1 - t3, e2);
  }
...
var polyInOut = function custom3(e2) {
  e2 = +e2;
  function polyInOut2(t3) {
    return ((t3 *= 2) <= 1 ? Math.pow(t3, e2) : 2 - Math.pow(2 - t3, e2)) / 2;
  }
...
var backOut = function custom5(s2) {
  s2 = +s2;
  function backOut2(t3) {
    return --t3 * t3 * ((t3 + 1) * s2 + t3) + 1;
  }
...
var backInOut = function custom6(s2) {
  s2 = +s2;
  function backInOut2(t3) {
    return ((t3 *= 2) < 1 ? t3 * t3 * ((s2 + 1) * t3 - s2) : (t3 -= 2) * t3 * ((s2 + 1) * t3 + s2) + 2) / 2;
  }
...
var elasticIn = function custom7(a3, p2) {
  ...
  function elasticIn2(t3) {
    return a3 * tpmt(- --t3) * Math.sin((s2 - t3) / p2);
  }
...
var elasticOut = function custom8(a3, p2) {
  var s2 = Math.asin(1 / (a3 = Math.max(1, a3))) * (p2 /= tau);
  function elasticOut2(t3) {
    return 1 - a3 * tpmt(t3 = +t3) * Math.sin((t3 + s2) / p2);
  }
...
var elasticInOut = function custom9(a3, p2) {
  var s2 = Math.asin(1 / (a3 = Math.max(1, a3))) * (p2 /= tau);
  function elasticInOut2(t3) {
    return ((t3 = t3 * 2 - 1) < 0 ? a3 * tpmt(-t3) * Math.sin((s2 - t3) / p2) : 2 - a3 * tpmt(t3) * Math.sin((s2 + t3) / p2)) / 2;
  }
...
function zoom_default2() {
  ...
  zoom2.translateTo = function(selection2, x3, y3, p2, event) {
    zoom2.transform(selection2, function() {
      ...
      return constrain(identity.translate(p0[0], p0[1]).scale(t3.k).translate(
        typeof x3 === "function" ? -x3.apply(this, arguments) : -x3,
        typeof y3 === "function" ? -y3.apply(this, arguments) : -y3
      ), e2, translateExtent);
    }, p2, event);
  ...
  function touchmoved(event, ...args) {
    ...
    for (i2 = 0; i2 < n2; ++i2) {
      t3 = touches[i2], p2 = pointer_default(t3, this);
      if (g2.touch0 && g2.touch0[2] === t3.identifier) g2.touch0[0] = p2;
      else if (g2.touch1 && g2.touch1[2] === t3.identifier) g2.touch1[0] = p2;
    }
    t3 = g2.that.__zoom;
    if (g2.touch1) {
  ...
  function touchended(event, ...args) {
    ...
    for (i2 = 0; i2 < n2; ++i2) {
      t3 = touches[i2];
      if (g2.touch0 && g2.touch0[2] === t3.identifier) delete g2.touch0;
      else if (g2.touch1 && g2.touch1[2] === t3.identifier) delete g2.touch1;
    }
  ...
  zoom2.wheelDelta = function(_2) {
    return arguments.length ? (wheelDelta = typeof _2 === "function" ? _2 : constant_default3(+_2), zoom2) : wheelDelta;
  };
  zoom2.filter = function(_2) {
    return arguments.length ? (filter3 = typeof _2 === "function" ? _2 : constant_default3(!!_2), zoom2) : filter3;
  };
  zoom2.touchable = function(_2) {
    return arguments.length ? (touchable = typeof _2 === "function" ? _2 : constant_default3(!!_2), zoom2) : touchable;
  };
  zoom2.extent = function(_2) {
    return arguments.length ? (extent = typeof _2 === "function" ? _2 : constant_default3([[+_2[0][0], +_2[0][1]], [+_2[1][0], +_2[1][1]]]), zoom2) : extent;
  };
...
function arrayMap(array2, iteratee2) {
  var index7 = -1, length = array2 == null ? 0 : array2.length, result2 = Array(length);
  while (++index7 < length) {
    result2[index7] = iteratee2(array2[index7], index7, array2);
  }
  return result2;
}
...
var constant_default4 = constant;
...
var baseSetToString = !defineProperty_default ? identity_default : function(func, string) {
  return defineProperty_default(func, "toString", {
    "configurable": true,
    "enumerable": false,
    "value": constant_default4(string),
    "writable": true
  });
};
...
function arrayEach(array2, iteratee2) {
  ...
  while (++index7 < length) {
    if (iteratee2(array2[index7], index7, array2) === false) {
      break;
    }
  }
  return array2;
...
function reorder(array2, indexes) {
  ...
  while (length--) {
    ...
    array2[length] = isIndex_default(index7, arrLength) ? oldArray[index7] : void 0;
  }
  return array2;
}
...
function overRest(func, start2, transform3) {
  ...
  return function() {
    var args = arguments, index7 = -1, length = nativeMax4(args.length - start2, 0), array2 = Array(length);
    while (++index7 < length) {
...
function arrayPush(array2, values2) {
  var index7 = -1, length = values2.length, offset = array2.length;
  while (++index7 < length) {
    array2[offset + index7] = values2[index7];
  }
  return array2;
}
...
function arrayReduce(array2, iteratee2, accumulator, initAccum) {
  ...
  while (++index7 < length) {
    accumulator = iteratee2(accumulator, array2[index7], index7, array2);
  }
  return accumulator;
}
...
function chunk(array2, size2, guard) {
  if (guard ? isIterateeCall_default(array2, size2, guard) : size2 === void 0) {
    size2 = 1;
  } else {
  ...
  while (index7 < length) {
    result2[resIndex++] = baseSlice_default(array2, index7, index7 += size2);
  }
  return result2;
}
...
function clamp(number, lower2, upper) {
  ...
  return baseClamp_default(toNumber_default(number), lower2, upper);
}
...
function concat() {
  ...
  var args = Array(length - 1), array2 = arguments[0], index7 = length;
  while (index7--) {
...
function baseDifference(array2, values2, iteratee2, comparator) {
  var index7 = -1, includes2 = arrayIncludes_default, isCommon = true, length = array2.length, result2 = [], valuesLength = values2.length;
  if (!length) {
    return result2;
  }
  if (iteratee2) {
...
function baseWhile(array2, predicate, isDrop, fromRight) {
  ...
  return isDrop ? baseSlice_default(array2, fromRight ? 0 : index7, fromRight ? index7 + 1 : length) : baseSlice_default(array2, fromRight ? index7 + 1 : 0, fromRight ? length : index7);
}
...
function findIndex(array2, predicate, fromIndex) {
  ...
  return baseFindIndex_default(array2, baseIteratee_default(predicate, 3), index7);
}
...
function findLastIndex(array2, predicate, fromIndex) {
  ...
  return baseFindIndex_default(array2, baseIteratee_default(predicate, 3), index7, true);
}
...
function indexOf(array2, value, fromIndex) {
  ...
  return baseIndexOf_default(array2, value, index7);
}
...
var invert = createInverter_default(function(result2, value, key) {
  ...
  result2[value] = key;
}, constant_default4(identity_default));
...
function lastIndexOf(array2, value, fromIndex) {
  ...
  return value === value ? strictLastIndexOf_default(array2, value, index7) : baseFindIndex_default(array2, baseIsNaN_default, index7, true);
}
...
function baseSum(array2, iteratee2) {
  var result2, index7 = -1, length = array2.length;
  while (++index7 < length) {
    var current = iteratee2(array2[index7]);
    if (current !== void 0) {
...
function basePullAll(array2, values2, iteratee2, comparator) {
  var indexOf2 = comparator ? baseIndexOfWith_default : baseIndexOf_default, index7 = -1, length = values2.length, seen = array2;
  if (array2 === values2) {
  ...
  while (length--) {
    ...
    if (length == lastIndex || index7 !== previous) {
      ...
      if (isIndex_default(index7)) {
        splice3.call(array2, index7, 1);
      } else {
        baseUnset_default(array2, index7);
      }
    }
  }
  return array2;
...
var pullAt = flatRest_default(function(array2, indexes) {
  ...
  basePullAt_default(array2, arrayMap_default(indexes, function(index7) {
...
function shuffleSelf(array2, size2) {
  ...
  while (++index7 < size2) {
    var rand = baseRandom_default(index7, lastIndex), value = array2[rand];
...
function sortedIndexOf(array2, value) {
  var length = array2 == null ? 0 : array2.length;
  if (length) {
    var index7 = baseSortedIndex_default(array2, value);
    if (index7 < length && eq_default(array2[index7], value)) {
      return index7;
    }
  }
  return -1;
...
function sortedLastIndexOf(array2, value) {
  var length = array2 == null ? 0 : array2.length;
  if (length) {
    var index7 = baseSortedIndex_default(array2, value, true) - 1;
    if (eq_default(array2[index7], value)) {
      return index7;
    }
  }
  return -1;
...
function baseUniq(array2, iteratee2, comparator) {
  var index7 = -1, includes2 = arrayIncludes_default, length = array2.length, isCommon = true, result2 = [], seen = result2;
  if (comparator) {
    isCommon = false;
    includes2 = arrayIncludesWith_default;
...
function unzip(array2) {
  ...
  return baseTimes_default(length, function(index7) {
    return arrayMap_default(array2, baseProperty_default(index7));
  });
}
...
function baseXor(arrays, iteratee2, comparator) {
  ...
  while (++index7 < length) {
    ...
    while (++othIndex < length) {
      if (othIndex != index7) {
        result2[index7] = baseDifference_default(result2[index7] || array2, arrays[othIndex], iteratee2, comparator);
      }
    }
  }
...
function hsvToRgb(h2, s2, v2) {
  ...
  s2 = bound01(s2, 100);
  v2 = bound01(v2, 100);
  var i2 = Math.floor(h2), f2 = h2 - i2, p2 = v2 * (1 - s2), q2 = v2 * (1 - f2 * s2), t3 = v2 * (1 - (1 - f2) * s2), mod = i2 % 6, r2 = [v2, q2, p2, p2, t3, v2][mod], g2 = [t3, v2, v2, q2, p2, p2][mod], b10 = [p2, p2, t3, v2, v2, q2][mod];
  return {
    r: r2 * 255,
    g: g2 * 255,
    b: b10 * 255
...
function rgbToHex(r2, g2, b10, allow3Char) {
  var hex = [pad2(Math.round(r2).toString(16)), pad2(Math.round(g2).toString(16)), pad2(Math.round(b10).toString(16))];
...
function rgbaToHex(r2, g2, b10, a3, allow4Char) {
  var hex = [pad2(Math.round(r2).toString(16)), pad2(Math.round(g2).toString(16)), pad2(Math.round(b10).toString(16)), pad2(convertDecimalToHex(a3))];
...
function rgbaToArgbHex(r2, g2, b10, a3) {
  var hex = [pad2(convertDecimalToHex(a3)), pad2(Math.round(r2).toString(16)), pad2(Math.round(g2).toString(16)), pad2(Math.round(b10).toString(16))];
  return hex.join("");
}
...
function L(n2, l2, u2, t3, i2, r2, o2, e2, f2, c5, s2) {
  var a3, h2, p2, v2, y3, _2, g2, m3 = t3 && t3.__k || w, b10 = l2.length;
  for (f2 = T(u2, l2, m3, f2, b10), a3 = 0; a3 < b10; a3++) null != (p2 = u2.__k[a3]) && (h2 = -1 != p2.__i && m3[p2.__i] || d, p2.__i = a3, _2 = q(n2, p2, h2, i2, r2, o2, e2, f2, c5, s2), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), s2.push(p2.ref, p2.__c || v2, p2)), null == y3 && null != v2 && (y3 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f2 = j(p2, f2, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y3, f2;
}
function T(n2, l2, u2, t3, i2) {
  var r2, o2, e2, f2, c5, s2 = u2.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++) null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? ("string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? o2 = n2.__k[r2] = x(null, o2, null, null, null) : g(o2) ? o2 = n2.__k[r2] = x(S, { children: o2 }, null, null, null) : void 0 === o2.constructor && o2.__b > 0 ? o2 = n2.__k[r2] = x(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : n2.__k[r2] = o2, f2 = r2 + h2, o2.__ = n2, o2.__b = n2.__b + 1, e2 = null, -1 != (c5 = o2.__i = O(o2, u2, f2, a3)) && (a3--, (e2 = u2[c5]) && (e2.__u |= 2)), null == e2 || null == e2.__v ? (-1 == c5 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c5 != f2 && (c5 == f2 - 1 ? h2-- : c5 == f2 + 1 ? h2++ : (c5 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (a3) for (r2 = 0; r2 < s2; r2++) null != (e2 = u2[r2]) && 0 == (2 & e2.__u) && (e2.__e == t3 && (t3 = $(e2)), K(e2, e2));
  return t3;
}
function j(n2, l2, u2, t3) {
  var i2, r2;
  if ("function" == typeof n2.type) {
    for (i2 = n2.__k, r2 = 0; i2 && r2 < i2.length; r2++) i2[r2] && (i2[r2].__ = n2, l2 = j(i2[r2], l2, u2, t3));
    return l2;
  }
...
function O(n2, l2, u2, t3) {
  var i2, r2, o2, e2 = n2.key, f2 = n2.type, c5 = l2[u2], s2 = null != c5 && 0 == (2 & c5.__u);
  if (null === c5 && null == e2 || s2 && e2 == c5.key && f2 == c5.type) return u2;
  if (t3 > (s2 ? 1 : 0)) {
    for (i2 = u2 - 1, r2 = u2 + 1; i2 >= 0 || r2 < l2.length; ) if (null != (c5 = l2[o2 = i2 >= 0 ? i2-- : r2++]) && 0 == (2 & c5.__u) && e2 == c5.key && f2 == c5.type) return o2;
  }
  return -1;
}
function z(n2, l2, u2) {
...
function N(n2, l2, u2, t3, i2) {
  ...
  n: if ("style" == l2) if ("string" == typeof u2) n2.style.cssText = u2;
    ...
    if ("string" == typeof t3 && (n2.style.cssText = t3 = ""), t3) for (l2 in t3) u2 && l2 in u2 || z(n2.style, l2, "");
    if (u2) for (l2 in u2) t3 && u2[l2] == t3[l2] || z(n2.style, l2, u2[l2]);
  }
  else if ("o" == l2[0] && "n" == l2[1]) r2 = l2 != (l2 = l2.replace(a, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t3 ? u2[s] = t3[s] : (u2[s] = h, n2.addEventListener(l2, r2 ? v : p, r2)) : n2.removeEventListener(l2, r2 ? v : p, r2);
  else {
...
function V(n2) {
  return function(u2) {
    if (this.l) {
      ...
      if (null == u2[c]) u2[c] = h++;
      else if (u2[c] < t3[s]) return;
      return t3(l.event ? l.event(u2) : u2);
    }
  };
}
function q(n2, u2, t3, i2, r2, o2, e2, f2, c5, s2) {
  var a3, h2, p2, v2, y3, d2, _2, k2, x3, M, $2, I2, P2, A2, H2, T2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t3.__u && (c5 = !!(32 & t3.__u), o2 = [f2 = u2.__e = t3.__e]), (a3 = l.__b) && a3(u2);
  n: if ("function" == typeof T2) try {
    if (k2 = u2.props, x3 = T2.prototype && T2.prototype.render, M = (a3 = T2.contextType) && i2[a3.__c], $2 = a3 ? M ? M.props.value : a3.__ : i2, t3.__c ? _2 = (h2 = u2.__c = t3.__c).__ = h2.__E : (x3 ? u2.__c = h2 = new T2(k2, $2) : (u2.__c = h2 = new C(k2, $2), h2.constructor = T2, h2.render = Q), M && M.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), x3 && null == h2.__s && (h2.__s = h2.state), x3 && null != T2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = m({}, h2.__s)), m(h2.__s, T2.getDerivedStateFromProps(k2, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2) x3 && null == T2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), x3 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
      if (x3 && null == T2.getDerivedStateFromProps && k2 !== v2 && null != h2.componentWillReceiveProps && h2.componentWillReceiveProps(k2, $2), u2.__v == t3.__v || !h2.__e && null != h2.shouldComponentUpdate && false === h2.shouldComponentUpdate(k2, h2.__s, $2)) {
        u2.__v != t3.__v && (h2.props = k2, h2.state = h2.__s, h2.__d = false), u2.__e = t3.__e, u2.__k = t3.__k, u2.__k.some(function(n3) {
          n3 && (n3.__ = u2);
    ...
    if (h2.context = $2, h2.props = k2, h2.__P = n2, h2.__e = false, I2 = l.__r, P2 = 0, x3) h2.state = h2.__s, h2.__d = false, I2 && I2(u2), a3 = h2.render(h2.props, h2.state, h2.context), w.push.apply(h2.__h, h2._sb), h2._sb = [];
    else do {
      h2.__d = false, I2 && I2(u2), a3 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s;
    } while (h2.__d && ++P2 < 25);
    h2.state = h2.__s, null != h2.getChildContext && (i2 = m(m({}, i2), h2.getChildContext())), x3 && !p2 && null != h2.getSnapshotBeforeUpdate && (d2 = h2.getSnapshotBeforeUpdate(v2, y3)), A2 = null != a3 && a3.type === S && null == a3.key ? E(a3.props.children) : a3, f2 = L(n2, g(A2) ? A2 : [A2], u2, t3, i2, r2, o2, e2, f2, c5, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e2.push(h2), _2 && (h2.__E = h2.__ = null);
  } catch (n3) {
    ...
    else u2.__e = t3.__e, u2.__k = t3.__k, n3.then || B(u2);
    l.__e(n3, u2, t3);
  }
  else null == o2 && u2.__v == t3.__v ? (u2.__k = t3.__k, u2.__e = t3.__e) : f2 = u2.__e = G(t3.__e, u2, t3, i2, r2, o2, e2, c5, s2);
...
function G(u2, t3, i2, r2, o2, e2, f2, c5, s2) {
  var a3, h2, p2, v2, y3, w2, _2, m3 = i2.props || d, k2 = t3.props, x3 = t3.type;
  if ("svg" == x3 ? o2 = "http://www.w3.org/2000/svg" : "math" == x3 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e2) {
    for (a3 = 0; a3 < e2.length; a3++) if ((y3 = e2[a3]) && "setAttribute" in y3 == !!x3 && (x3 ? y3.localName == x3 : 3 == y3.nodeType)) {
      u2 = y3, e2[a3] = null;
      break;
    }
  }
  if (null == u2) {
    ...
    u2 = document.createElementNS(o2, x3, k2.is && k2), c5 && (l.__m && l.__m(t3, e2), c5 = false), e2 = null;
  }
  if (null == x3) m3 === k2 || c5 && u2.data == k2 || (u2.data = k2);
  else {
    if (e2 = e2 && n.call(u2.childNodes), !c5 && null != e2) for (m3 = {}, a3 = 0; a3 < u2.attributes.length; a3++) m3[(y3 = u2.attributes[a3]).name] = y3.value;
    for (a3 in m3) y3 = m3[a3], "dangerouslySetInnerHTML" == a3 ? p2 = y3 : "children" == a3 || a3 in k2 || "value" == a3 && "defaultValue" in k2 || "checked" == a3 && "defaultChecked" in k2 || N(u2, a3, null, y3, o2);
    for (a3 in k2) y3 = k2[a3], "children" == a3 ? v2 = y3 : "dangerouslySetInnerHTML" == a3 ? h2 = y3 : "value" == a3 ? w2 = y3 : "checked" == a3 ? _2 = y3 : c5 && "function" != typeof y3 || m3[a3] === y3 || N(u2, a3, y3, m3[a3], o2);
    if (h2) c5 || p2 && (h2.__html == p2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t3.__k = [];
    else if (p2 && (u2.innerHTML = ""), L("template" == t3.type ? u2.content : u2, g(v2) ? v2 : [v2], t3, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e2, f2, e2 ? e2[0] : i2.__k && $(i2, 0), c5, s2), null != e2) for (a3 = e2.length; a3--; ) b(e2[a3]);
    c5 || (a3 = "value", "progress" == x3 && null == w2 ? u2.removeAttribute("value") : null != w2 && (w2 !== u2[a3] || "progress" == x3 && !w2 || "option" == x3 && w2 != m3[a3]) && N(u2, a3, w2, m3[a3], o2), a3 = "checked", null != _2 && _2 != u2[a3] && N(u2, a3, _2, m3[a3], o2));
  }
  return u2;
}
function J(n2, u2, t3) {
...
function K(n2, u2, t3) {
  ...
  if (i2 = n2.__k) for (r2 = 0; r2 < i2.length; r2++) i2[r2] && K(i2[r2], u2, t3 || "function" != typeof n2.type);
...
function link_default(links) {
  var id2 = index5, strength = defaultStrength, strengths, distance2 = constant_default5(30), distances, nodes, nDim, count, bias, random2, iterations = 1;
  if (links == null) links = [];
...
function manyBody_default() {
  var nodes, nDim, node, random2, alpha, strength = constant_default5(-30), strengths, distanceMin2 = 1, distanceMax2 = Infinity, theta2 = 0.81;
  function force(_2) {
...
var utils = {
  ...
  compute: function(t3, points, _3d) {
    ...
    if (order < 4) {
      let mt2 = mt * mt, t22 = t3 * t3, a3, b10, c5, d2 = 0;
      if (order === 2) {
  ...
  roots: function(points, line) {
    ...
    if (order === 2) {
      ...
      if (d3 !== 0) {
        ...
        return [(2 * b11 - c6) / (2 * b11 - 2 * c6)].filter(reduce2);
      }
      return [];
    }
    ...
    if (utils.approximately(d2, 0)) {
      if (utils.approximately(a3, 0)) {
        ...
        return [-c5 / b10].filter(reduce2);
      }
      const q3 = sqrt(b10 * b10 - 4 * a3 * c5), a22 = 2 * a3;
      return [(q3 - b10) / a22, (-b10 - q3) / a22].filter(reduce2);
    }
    a3 /= d2;
    b10 /= d2;
    c5 /= d2;
    ...
    if (discriminant < 0) {
      ...
      x22 = t1 * cos((phi + tau2) / 3) - a3 / 3;
      x3 = t1 * cos((phi + 2 * tau2) / 3) - a3 / 3;
...
var Bezier = class _Bezier {
  ...
  on(point, error) {
    ...
    for (let i2 = 0, c5, t3 = 0; i2 < lut.length; i2++) {
      c5 = lut[i2];
      if (utils.dist(c5, point) < error) {
        hits.push(c5);
        t3 += i2 / lut.length;
      }
    }
  ...
  offset(t3, d2) {
    if (typeof d2 !== "undefined") {
      const c5 = this.get(t3), n2 = this.normal(t3);
      const ret = {
        c: c5,
        n: n2,
        x: c5.x + n2.x * d2,
...
function ramp(range2) {
  ...
  return function(t3) {
    return range2[Math.max(0, Math.min(n2 - 1, Math.floor(t3 * n2)))];
  };
}
    ...
    (this._animationCycle = function animate() {
      ...
      if (state.enablePointerInteraction) {
        ...
        if (obj !== state.hoverObj) {
          ...
          state.canvas.classList[(obj && state["on".concat(objType, "Click")] || !obj && state.onBackgroundClick) && index3(state.showPointerCursor)(obj === null || obj === void 0 ? void 0 : obj.d) ? "add" : "remove"]("clickable");
          state.hoverObj = obj;
        }
